        ...
        <div id="table">
            ...
            <Fragment key="ferriswheel">
                <Fragment key="ferriswheelcar12">
                    ...
                    <Box boxId={constants.ferriswheelcar12BoxId}
                        ...
                        onBall1Move={() => props.ball1MoveHandler(constants.ferriswheelcar12FeatureId)}
                        left="160px"
                        top="246px"
                        height="48px"
                        width="65px"
                ...
                <Fragment key="ferriswheelcar34">
                    ...
                    <Box boxId={constants.ferriswheelcar34BoxId}
                        ...
                        groupBoxIds={constants.ferriswheelGroupBoxIds}
                        onBall1Move={() => props.ball1MoveHandler(constants.ferriswheelcar34FeatureId)}
                        left="255px"
                        top="230px"
                        height="40px"
                        width="62px"
                ...
                <Fragment key="ferriswheelcar56">
                    ...
                    <Box boxId={constants.ferriswheelcar56BoxId}
                        ...
                        groupBoxIds={constants.ferriswheelGroupBoxIds}
                        onBall1Move={() => props.ball1MoveHandler(constants.ferriswheelcar56FeatureId)}
                        left="350px"
                        top="246px"
                        height="48px"
                        width="62px"
            ...
            <Fragment key="bumpers">
                <Fragment key="bumper12">
                    ...
                    <Box boxId={constants.bumper121st1BoxId}
                        ...
                        onBall1Move={() => props.ball1MoveHandler(constants.bumper12FeatureId)}
                        left="155px"
                        top="373px"
                        height="25px"
                        width="25px"
                ...
                <Fragment key="bumper34">
                    ...
                    <Box boxId={constants.bumper341st3BoxId}
                        ...
                        groupBoxIds={constants.bumperGroupBoxIds}
                        onBall1Move={() => props.ball1MoveHandler(constants.bumper34FeatureId)}
                        left="288px"
                        top="373px"
                        height="25px"
                        width="25px"
                ...
                <Fragment key="bumper56">
                    ...
                    <Box boxId={constants.bumper561st5BoxId}
                        ...
                        groupBoxIds={constants.bumperGroupBoxIds}
                        onBall1Move={() => props.ball1MoveHandler(constants.bumper56FeatureId)}
                        left="221px"
                        top="475px"
                        height="25px"
                        width="25px"
            ...
            <Fragment key="featofstrength">
                <Fragment key="featofstrength-1">
                    ...
                    <Box boxId={constants.hammerSpace1BoxId}
                        ...
                        onBall1Move={() => props.ball1MoveHandler(constants.hammerSpace1FeatureId)}
                        left="376px"
                        top="535px"
                        height="25px"
                        width="25px"
                ...
                <Fragment key="featofstrength-2">
                    ...
                    <Box boxId={constants.hammerSpace2BoxId}
                        ...
                        groupBoxIds={constants.hammerSpaceGroupBoxIds}
                        onBall1Move={() => props.ball1MoveHandler(constants.hammerSpace2FeatureId)}
                        left="388px"
                        top="505px"
                        height="25px"
                        width="25px"
                ...
                <Fragment key="featofstrength-3">
                    ...
                    <Box boxId={constants.hammerSpace3BoxId}
                        ...
                        groupBoxIds={constants.hammerSpaceGroupBoxIds}
                        onBall1Move={() => props.ball1MoveHandler(constants.hammerSpace3FeatureId)}
                        left="398px"
                        top="477px"
                        height="25px"
                        width="25px"
                ...
                <Fragment key="featofstrength-4">
                    ...
                    <Box boxId={constants.hammerSpace4BoxId}
                        ...
                        groupBoxIds={constants.hammerSpaceGroupBoxIds}
                        onBall1Move={() => props.ball1MoveHandler(constants.hammerSpace4FeatureId)}
                        left="409px"
                        top="448px"
                        height="25px"
                        width="25px"
                ...
                <Fragment key="featofstrength-5">
                    ...
                    <Box boxId={constants.hammerSpace5BoxId}
                        ...
                        groupBoxIds={constants.hammerSpaceGroupBoxIds}
                        onBall1Move={() => props.ball1MoveHandler(constants.hammerSpace5FeatureId)}
                        left="420px"
                        top="420px"
                        height="25px"
                        width="25px"
                ...
                <Fragment key="featofstrength-6">
                    ...
                    <Box boxId={constants.hammerSpace6BoxId}
                        ...
                        groupBoxIds={constants.hammerSpaceGroupBoxIds}
                        onBall1Move={() => props.ball1MoveHandler(constants.hammerSpace6FeatureId)}
                        left="430px"
                        top="390px"
                        height="25px"
                        width="25px"
                ...
                <Fragment key="yelDropTargets">
                    <Fragment key="yelDropTarget12">
                        ...
                        <Box boxId={constants.yelDropTarget12BoxId}
                            ...
                            onBall1Move={() => props.ball1MoveHandler(constants.yelDropTarget12FeatureId)}
                            left="30px"
                            top="675px"
                            height="60px"
                            width="35px"
                    ...
                    <Fragment key="yelDropTarget34">
                        ...
                        <Box boxId={constants.yelDropTarget34BoxId}
                            ...
                            groupBoxIds={constants.yelDropTargetGroupBoxIds}
                            onBall1Move={() => props.ball1MoveHandler(constants.yelDropTarget34FeatureId)}
                            left="60px"
                            top="615px"
                            height="60px"
                            width="35px"
                    ...
                    <Fragment key="yelDropTarget56">
                        ...
                        <Box boxId={constants.yelDropTarget56BoxId}
                            ...
                            groupBoxIds={constants.yelDropTargetGroupBoxIds}
                            onBall1Move={() => props.ball1MoveHandler(constants.yelDropTarget56FeatureId)}
                            left="95px"
                            top="560px"
                            height="60px"
                            width="35px"
                ...
                <Fragment key="redDropTargets">
                    <Fragment key="redDropTarget12">
                        ...
                        <Box boxId={constants.redDropTarget12BoxId}
                            ...
                            onBall1Move={() => props.ball1MoveHandler(constants.redDropTarget12FeatureId)}
                            left="415px"
                            top="570px"
                            height="50px"
                            width="35px"
                    ...
                    <Fragment key="redDropTarget3">
                        ...
                        <Box boxId={constants.redDropTarget3BoxId}
                            ...
                            groupBoxIds={constants.redDropTargetGroupBoxIds}
                            onBall1Move={() => props.ball1MoveHandler(constants.redDropTarget3FeatureId)}
                            left="435px"
                            top="621px"
                            height="40px"
                            width="35px"
                    ...
                    <Fragment key="redDropTarget4">
                        ...
                        <Box boxId={constants.redDropTarget4BoxId}
                            ...
                            groupBoxIds={constants.redDropTargetGroupBoxIds}
                            onBall1Move={() => props.ball1MoveHandler(constants.redDropTarget4FeatureId)}
                            left="455px"
                            top="665px"
                            height="42px"
                            width="35px"
                    ...
                    <Fragment key="redDropTarget56">
                        ...
                        <Box boxId={constants.redDropTarget56BoxId}
                            ...
                            groupBoxIds={constants.redDropTargetGroupBoxIds}
                            onBall1Move={() => props.ball1MoveHandler(constants.redDropTarget56FeatureId)}
                            left="480px"
                            top="710px"
                            height="55px"
                            width="35px"
            ...
            <Fragment key="outlanes">
                <Outlane boxId={constants.redOutlaneBoxId}
                    ...
                    onBall1Move={() => props.ball1MoveHandler(constants.startFeatureId)}
                    left="18px"
                    top="815px"
                    {...props}
                />
            ...
            <Fragment key="inlanes">
                <DashedBox boxId={constants.redInlaneBoxId}
                    ...
                    onBall1Move={() => props.ball1MoveHandler(constants.redFlipperFeatureId)}
                    left="94px"
                    top="821px"
                    height="25px"
                    width="25px"
                ...
                <DashedBox boxId={constants.yelInlaneBoxId}
                    ...
                    onBall1Move={() => props.ball1MoveHandler(constants.yelFlipperFeatureId)}
                    left="419px"
                    top="821px"
                    height="25px"
                    width="25px"
