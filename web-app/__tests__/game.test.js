...
describe("Game", () => {
    ...
    describe('when multiball is active', () => {
        ...
        describe('when nudging a die', () => {
            it('only increments nudges used by one', async () => {
                //#region arrange
                const DIE_VALUES = [
                    [1, 2], // move from start to yel drop target 12
                    [1, 1], // move to yel flipper box 1
                    ...
                    // nudge die 2 (=2) down to 1
                    // move ball 2 with die 2 (=1) to bumper 12 1st 1 box
                    [1, 6], // final roll that avoids tilt
                ];
                const user = userEvent.setup();
                render(<Game dieValues={DIE_VALUES} />);
                //#endregion
                ...
                //#endregion
                //#region assert
                expect(screen.getByTitle("nudges-used").innerHTML).toEqual("Nudges Used: 1");
                //#endregion
            });
        });
        describe('when tilting', () => {
            it('should move ball 1 to START_BOX_ID', async () => {
                //#region arrange
                const DIE_VALUES = [
                    [1, 2], // move from start to yel drop target 12
                    [1, 1], // move to yel flipper box 1
            ...
            it('should move ball 2 to DRAIN_BOX_ID', async () => {
                //#region arrange
                const DIE_VALUES = [
                    [1, 2], // move from start to yel drop target 12
                    [1, 1], // move to yel flipper box 1
            ...
            it('should auto-select ball 1', async () => {
                //#region arrange
                const DIE_VALUES = [
                    [1, 2], // move from start to yel drop target 12
                    [1, 1], // move to yel flipper box 1
    ...
    describe('after multiball is deactivated', () => {
        ...
        describe('after the round has ended', () => {
            describe('when ending the round on the same turn that multiball was ended', () => {
                it('should allow the user to move the only ball without clicking on it', async () => {
                    //#region arrange
                    const DIE_VALUES = [
                        [1, 2], // move from start to yel drop target 12
                        [1, 1], // move to yel flipper box 1
                        ...
                        [1, 6],
                        // move ball 1 with die 1 (=1) from yel drop target 56 to the drain box
                        // move ball 2 with die 2 (=6) from start to the drain box
                        [5, 5], // move ball 1 from start to ferris wheel car 56
                        [1, 1], // final roll
                    ];
                    const user = userEvent.setup();
                    render(<Game dieValues={DIE_VALUES} />);
            ...
            describe('when ending the round on a turn after the turn in which multiball was ended', () => {
                it('should allow the user to move the only ball without clicking on it', async () => {
                    //#region arrange
                    const DIE_VALUES = [
                        [1, 2], // move from start to yel drop target 12
                        ...
                        // select yel multiball bonus
                        [2, 6],
                        // move ball 1 with die 2 (=6) from yel drop target 56 to the drain box
                        // move ball 2 with die 1 (=2) from start to the red inlane
                        [1, 1], // move ball 2 from red inlane to the drain box
                        [5, 5], // move ball 1 from start to ferris wheel car 56
                        [1, 1], // final roll
                    ];
                    const user = userEvent.setup();
